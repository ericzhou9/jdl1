package net.zy.application.repository;

import net.zy.application.Jdl1App;
import net.zy.application.config.Constants;
import net.zy.application.config.audit.AuditEventConverter;
import net.zy.application.domain.PersistentAuditEvent;
...
import static net.zy.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
