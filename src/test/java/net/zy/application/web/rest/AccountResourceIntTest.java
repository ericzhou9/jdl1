package net.zy.application.web.rest;

import net.zy.application.config.Constants;
import net.zy.application.Jdl1App;
import net.zy.application.domain.Authority;
import net.zy.application.domain.User;
import net.zy.application.repository.AuthorityRepository;
import net.zy.application.repository.UserRepository;
import net.zy.application.security.AuthoritiesConstants;
import net.zy.application.service.MailService;
import net.zy.application.service.dto.UserDTO;
import net.zy.application.web.rest.errors.ExceptionTranslator;
import net.zy.application.web.rest.vm.KeyAndPasswordVM;
import net.zy.application.web.rest.vm.ManagedUserVM;
import net.zy.application.service.UserService;
...
@SpringBootTest(classes = Jdl1App.class)
